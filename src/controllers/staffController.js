...
export const getStaffList = async (req, res) => {
    try {
      ...
      const formattedStaff = staff.map((staffMember) => {
        ...
        const fullName = `${memberInfo.first_name || ""} ${memberInfo.middle_name || ""} ${memberInfo.last_name || ""}`.trim();
        ...
        return {
          ...
          dateJoined: new Date(staffMember.date_joined).toLocaleDateString("en-GB"),
